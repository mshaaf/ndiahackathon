...
| Drone Trajectory Data | Date, time, latitude, longitude, altitude, gyroscope, acceleration, north/east/down position, orientation, wind speed and direction | Realistic motion shapes for position prediction and timing | No hostile or friendly labels. Transformed paths are motion shapes, never real attack traces. |
